...
function findSeniorStudentsWithCompletedAssignments(students) {
    return students.filter(function (student) { return student.senior && student.completedAssignments; });
}
;
var seniorStudentsWithCompletedAssignments = findSeniorStudentsWithCompletedAssignments(students);
